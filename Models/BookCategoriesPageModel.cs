...
namespace Catalin_Teburzuca_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Catalin_Teburzuca_lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Catalin_Teburzuca_lab2Context context,
